...
/*  for PRO users! -  THEME CONTENT WIDTH
============================== */
if ( ! isset( $content_width ) ) {
	$content_width = 1170;
}

/*  for PRO users! -  THEME VARIABLES
============================== */
define('TT_LIB', get_template_directory()  . '/lib');
define('TT_LIB_URI', get_template_directory_uri()  . '/lib');


/*  for PRO users! -  REDUX FRAMEWORK - THEME OPTIONS
============================== */
...
/*  for PRO users! -  REDUX FRAMEWORK - ADD FONTAWESOME ICON FONT
============================== */
...
/*  for PRO users! -  TGM PLUGIN ACTIVATION
============================== */
...
/*  for PRO users! -  LOAD ADMIN SCRIPT
============================== */
...
function tt_realty_scripts() {
	...
	/*  for PRO users! -  Move All Scripts in Footer
...
/*  for PRO users! -  CUSTOM LOGIN PAGE (wp-login.php)
============================== */
...
/*  for PRO users! -  Thumbnail size in wordpress 4.2.2. */
add_action( 'after_setup_theme', 'my_theme_setup' );
function my_theme_setup() {
	add_image_size( 'edit-screen-thumbnail', 150, 150, true );
}
/*  for PRO users! -  End Thumbnail size in wordpress 4.2.2. */
/*  for PRO users! -  Sidebars
============================== */
...
/*  for PRO users! -  AJAX - WordPress URL
============================== */
...
/*  for PRO users! -  Add "Lost Password" link to wp_login_form()
============================== */	
...
/*  for PRO users! -  Login Failed - Username & Password Entered, But Incorrect
...
/*  for PRO users! -  Login Form Bottom - Add Login Errors
============================== */
...
/*  for PRO users! -  Login Failed - No Username & Password Entered
http://www.paulund.co.uk/create-your-own-wordpress-login-page
============================== */
...
/*  for PRO users! -  Disable WP Admin Bar For Non-Admins
============================== */
...
/*  for PRO users! -  Disable wp-admin For Non-Admins, If Not Running Ajax OR Updating User Data
============================== */
...
/*  for PRO users! -  Login with Username OR Email Address
...
/*  for PRO users! -  CUSTOM MAP MARKERS ICONS
============================== */
...
/*  for PRO users! -  CONTACT FORM - Single Property
============================== */
...
function submit_property_contact_form() {
	...
	if ( wp_verify_nonce( $_POST['nonce'] ) && !empty( $_POST['email'] ) && !empty( $_POST['message'] ) ) {
		...
		if($realty_theme_option['property-contact-form-cc-admin']){
			$recipient=array();
			$recipient[]=$recipient = $_POST['agent_email'];
			$recipient[]=$recipient = $realty_theme_option['property-contact-form-cc-admin'];
		}
		else {
...
/*  for PRO users! -  CONTACT FORM - Single Agent
============================== */
...
/*  for PRO users! -  User - Property Submit - Delete Images
============================== */
...
/*  for PRO users! -  Add Role "agent". Run Once After Theme Activation.
...
/*  for PRO users! -  Property Submit Listing - Edit link
============================== */
...
/*  for PRO users! -  PayPal Payment Button
============================== */
...
/*  for PRO users! -  User Profile - Additional Fields
============================== */
...
/*  for PRO users! -  User Profile - Additional Field "Image" 
...
/*  for PRO users! -  User Profile - Save "Image" Field
============================== */
...
/*  for PRO users! -  User Profile - Delete User Image
============================== */
...
/*  for PRO users! -  Retrieve ttachment ID from file URL
...
/*  for PRO users! -  Theme Option - Body Classes
============================== */
...
/*  for PRO users! -  Page ID of Page Template "Property Search"
============================== */
...
/*  for PRO users! -  Open Graph Meta Tag (Facebook Sharer Thumbnail Assignment)
============================== */
...
function tt_custom_styles() {
	...
	/*  for PRO users! - if($realty_theme_option['property-listing-status-tag']){
		$status_color=$realty_theme_option['property-status-tag-color'];
	}*/
	echo "\n<style>\n";
	...
	if ( $realty_theme_option['property-featured-listing-layout'] != 'featured-title-view' || $realty_theme_option['property-listing-status-tag'] ) {
		echo ".property-item .tag { background: $color_accent; }\n";
	}
	...
	echo "#home-slideshow .title, #property-slideshow .title{ background-color: $color_accent }\n";
	echo "#home-slideshow .description .arrow-right, #property-slideshow .description .arrow-right{ border-left-color: $color_accent }\n";	
	echo "#home-slideshow.slideshow-custom .title:after{ background-color: $color_accent }\n";	
...
////////  Autoplay Slidehshow/////
<?php if ($realty_theme_option['property-single-auto-slideshow']) { ?>
		...
		jQuery('.flexslider-thumbnail').flexslider({
			...
			start: 
			function(slider) { // Initiate CSS spinner & fadeOut when slide is loaded
