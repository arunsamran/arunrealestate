...
if ( !is_page_template( 'template-intro.php' ) && !is_page_template( 'template-home-slideshow.php' ) && !is_page_template( 'template-home-properties-map.php' ) && !is_page_template( 'template-property-search.php' ) && !is_page_template( 'template-map-vertical.php' ) ) {
?>
</div><!-- .container -->
<?php } ?>
<?php 
