<?php
    ...
    require_once ( TT_LIB . '/advanced-custom-fields.php' );
      ...
      'fields'    => array(
		...
		/*  for PRO users! - array(
                'id'       								=> 'property-status-tag-color',
			    'type'     								=> 'color',
			    'title'    								=> __( 'Choose Color For Status Tag', 'tt' ), 
			    'subtitle' 								=> __( 'Choose Background Color For Status Tag', 'tt' ),
			    'default'  								=> '#43becc',
			    'validate' 								=> 'color',
			    'transparent'		  				=> false,
				'required' 	=> 	array( 'property-listing-status-tag', '=', '1' ),
		),*/
		array(
        ...
        array(
          ...
          'default'   => '400',
				...
				array(
          'id'        => 'property-single-auto-slideshow',
          'type'      => 'checkbox',
          'title'     => __( 'Property Slideshow Auto Play', 'tt' ),
          'subtitle'  => __( 'Single Property Slidshow Auto Play', 'tt' ),
          'desc'      => __( '', 'tt' ),
          'default'   => 0
        ),
        array(
          ...
          'default'   		=> 'title-style-gradient'
				...
				array(
          'id'        		=> 'property-video-layout',
          'type'      		=> 'radio',
          'title'     		=> __( 'Property Video Position', 'tt' ),
          'subtitle'  		=> __( 'If you select show in separate section it will be shown just above the content section.', 'tt' ),
          'desc'      		=> __( '', 'tt' ),	                
          'options'   		=> array(
            'show-in-gallery' 		=> __( 'Show In Gallery Slideshow', 'tt' ), 
            'show-above-content'	=> __( 'Show In Separate Section', 'tt' ), 
          ),
          'default'   		=> 'show-in-gallery'
        ),
        array(
    ...
    Redux::setSection( $opt_name, array(
      ...
      'fields'    => array(  
          ...
          'type'      => 'radio',
          'title'     => __( 'Propert Search Results Template', 'tt' ),
          'subtitle'  => __( '', 'tt' ),
          'desc'      => __( '', 'tt' ),
           //Must provide key => value pairs for radio options
          'options'   => array(
          	'default-template' 			=> __( 'Default Search Template', 'tt' ), 
            'vertical-map-template' 		=> __( 'Vertical Map Template', 'tt' ) . ' ' . __( '(Default)', 'tt' ),
          ),
		...
		/*  for PRO users! -  Property Payments
		============================== */
    Redux::setSection( $opt_name, array(
			'icon' 		=> 'fa fa-money',
    ...
    Redux::setSection( $opt_name, array(
			...
			'fields' 	=> array(
				array(
					...
					'type'      => 'checkbox',
					'title'     => __( 'Show Agent Info To Logged In Users', 'tt' ),
					'subtitle'  => __( 'For Property Pages', 'tt' ),
					'desc'      => __( 'Applies on property detailed pages, users can only see agent info when they are logged in.', 'tt' ),
					'default'   => 0
				),
				array(
					'id'        => 'show-agent-email',
